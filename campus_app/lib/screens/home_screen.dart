...
class _HomeScreenState extends State<HomeScreen> {
  ...
  final List<Map<String, dynamic>> _suggestions = [
    ...
    {
      'label': 'ID Card',
      'image': 'https://plus.unsplash.com/premium_photo-1681533650874-9a0c01a7ee53?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8OXx8SUQlMjBjYXJkfGVufDB8fDB8fHww',
      'related': ['Purse', 'PAN Card', 'Licence'],
    },
    
    {
      'label': 'Keys',
      'image': 'https://plus.unsplash.com/premium_photo-1681487704787-1d79d9f7ed0f?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MXx8a2V5c3xlbnwwfHwwfHx8MA%3D%3D',
      'related': ['Keychain', 'Bag', 'Purse'],
    },
    {
      'label': 'Umbrella',
      'image': 'https://images.unsplash.com/photo-1541697183324-e15d407c91cf?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8M3x8dW1icmVsbGF8ZW58MHx8MHx8fDA%3D',
      'related': ['Bag', 'Keys'],
    },
                      ...
                      Navigator.push(
                        ...
                        MaterialPageRoute(
                          ...
                          settings: RouteSettings(
                            arguments: {
                              'other_user_id':
                                  match['finder_user_id'] ?? 0,
                              'other_name':
                                  match['finder_name'] ?? 'Finder',
        ...
        return Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              GoldButton(
                text: 'Report ${suggestion['label']} as Lost',
                onPressed: () {
                  Navigator.pop(context);
                  Navigator.pushNamed(context, '/report',
                          arguments: suggestion['label'] as String)
                      .then((_) => _loadItems());
                },
              ),
              const SizedBox(height: 12),
                ...
                child: ListView(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: Row(
                        children: [
                          _toggleButton('Lost Items', _showLost,
                              () async {
                            _showLost = true;
                            setState(() {});
                            await _loadItems();
                          }),
                          _toggleButton('Found Items', !_showLost,
                              () async {
                            _showLost = false;
                            setState(() {});
                            await _loadItems();
...
class _ItemCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    print('DEBUG: item user_id=${item['user_id']} (${item['user_id'].runtimeType}), currentUserId=$currentUserId (${currentUserId.runtimeType}), isOwner=$isOwner');
                ...
                children: [
                  ...
                  Wrap(
                    ...
                    children: [
                      ...
                      // Message button — only on found items
                      if (!isLost)
                        GestureDetector(
                          onTap: () {
                            Navigator.push(
                      ...
                      // Got it back button — only owner on lost items
                      if (isLost && isOwner)
                        GestureDetector(
                          onTap: () async {
                          print('DEBUG: Got it back tapped for ${item['item_name']} userId=$currentUserId');
                            ...
                            print('DEBUG: confirm value = $confirm'); // ← add this line
                            if (confirm == true) {
                              print('DEBUG: Calling recoverItem for ${item['item_name']} userId=$currentUserId');
                              final result =
